        ...
        public bool AddWeapon(WeaponController weaponPrefab)
        {
            ...
            for (int i = 0; i < m_WeaponSlots.Length; i++)
            {
                ...
                if (m_WeaponSlots[i] == null)
                {
                    ...
                    if(weaponInstance.useNewPosition == true)
                    {
                        weaponInstance.transform.localPosition = weaponInstance.weaponPositin;
                        weaponInstance.transform.localRotation = weaponInstance.weaponRotation;
                    }
                    else
                    {
